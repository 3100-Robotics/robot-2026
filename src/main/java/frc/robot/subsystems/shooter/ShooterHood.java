...
public class ShooterHood extends SubsystemBase {
    ...
    private final SmartMotorControllerConfig armMotorConfig =
            new SmartMotorControllerConfig(this)
                    ...
                    .withTelemetry(
                            Constants.Shooter.YAMS.nameHood,
                            Constants.getAppropriateTelemetryLevel());

    private final SmartMotorController armMotorController =
            new TalonFXWrapper(armMotor, DCMotor.getKrakenX60(1), armMotorConfig);

    private ArmConfig hoodConfig =
            new ArmConfig(armMotorController)
