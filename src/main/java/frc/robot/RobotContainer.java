...
public class RobotContainer {
    ...
    // Drivetrain
    private final double maxSpeed = TunerConstantsV1Protobot.kSpeedAt12Volts.in(MetersPerSecond); // TODO: Get real max speed
    ...
    private final SwerveRequest.FieldCentric m_driveFieldCentric = new SwerveRequest.FieldCentric()
        .withDeadband(maxSpeed * 0.09)
        .withRotationalDeadband(maxAngularRate * 0.09) // Experiment with best values for these but they worked on Hawksbill
    ...
    private void configureBindings() {
        drivetrain.setDefaultCommand(
            drivetrain.applyRequest(
                () -> m_driveFieldCentric
                    .withVelocityX(maxSpeed * driverCtl.getLeftX())
                    .withVelocityY(maxSpeed * driverCtl.getLeftY())
                    .withRotationalRate(maxAngularRate * driverCtl.getRightX())
        ));
