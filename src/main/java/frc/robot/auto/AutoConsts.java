...
public class AutoConsts {
    public static Pose2d colorPose(Pose2d inputpose) {
        ...
        if (allianceColor.isPresent()) {
            return allianceColor.get() == Alliance.Red
                    ? inputpose.rotateAround(
                            new Translation2d(
                                    Constants.fieldLength.div(2), Constants.fieldWidth.div(2)),
    ...
    public static class OPAS {
        public static Pose2d INIT_POSE =
                new Pose2d(3.560119867324829, 1.6879488229751587, Rotation2d.kCCW_90deg);
    ...
    public static class LEFT {
        public static Pose2d INIT_POSE =
                new Pose2d(3.6330790519714355, 6.032428741455078, Rotation2d.kCW_90deg);
